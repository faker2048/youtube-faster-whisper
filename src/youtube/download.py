...
def __best_format_selector(ctx):
...
def download_audio(url: str, threads: int = 8) -> str:
    """Download an audio from YouTube and return the file name."""
    file_name = ""
    ...
    ydl_opts = {
        "format": "worstaudio[tbr>100]/bestaudio/best",
